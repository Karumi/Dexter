...
class AndroidPermissionService {
  ...
  int checkSelfPermission(@NonNull Context context, @NonNull String permission) {
    if (isHandledPermission(permission)) {
  ...
  /**
   * Before Marshmallow Android only handles properly permissions that are known.
   * <p/>
  ...
  private static boolean isHandledPermission(@NonNull String permission) {
    switch (permission) {
